...
export const metadata: Metadata = {
  title: "Privacy Policy — homelab68",
  description: "Privacy policy for Home Lab and homelab68 apps and services.",
};
    ...
    <div className="container mx-auto max-w-3xl px-4 py-12 md:py-16">
      ...
      <div className="prose prose-slate dark:prose-invert max-w-none">
        <p className="text-muted-foreground mb-6">
          Home Lab built app as a Free app. This SERVICE is provided by Home Lab at no cost and is
        ...
        <p className="text-muted-foreground mb-8">
          ...
          Conditions, which is accessible at this app unless otherwise defined in this Privacy
          Policy.
        </p>
        ...
        <h2 className="font-heading text-2xl font-semibold text-foreground mt-10 mb-4">Log Data</h2>
        <p className="text-muted-foreground mb-8">
          I want to inform you that whenever you use my Service, in a case of an error in the app I
          collect data and information (through third party services) on your phone called Log Data.
        ...
        <h2 className="font-heading text-2xl font-semibold text-foreground mt-10 mb-4">Cookies</h2>
        <p className="text-muted-foreground mb-8">
        ...
        <h2 className="font-heading text-2xl font-semibold text-foreground mt-10 mb-4">Security</h2>
        <p className="text-muted-foreground mb-8">
        ...
        <p className="text-muted-foreground mb-8">This policy is effective as of 2021-08-05.</p>
